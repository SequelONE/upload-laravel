...
return [
    ...
    */
    ...
    'distributed_deployment' => [
        ...
        'storage' => [ # 角色为储存服务器
            'middleware_cors' => '', # 跨域中间件UploadCORS类在Kernel.php中注册的名称
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | 【一般设置】位于 storage/app/ 下，修改默认值后需执行artisan命令upload:groups生成对应目录。
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | 【一般设置】可设置多个不同分组，各自拥有独立配置。新增分组并配置后，需执行artisan命令upload:groups创建对应目录。
    |
    */
