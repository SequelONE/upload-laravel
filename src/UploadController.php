...
class UploadController extends \App\Http\Controllers\Controller
{
    ...
    public function __construct()
    {
        ...
        // add UploadCORS middleware to the storage server when distributed deployment is enabled
    ...
    public function preprocess()
    {
        ...
        try {
            ...
            if ( Util::isDistributedWebHost() ) {
                throw new \Exception(trans('upload::messages.upload_error'));
            }
    ...
    public function saveChunk()
    {
        ...
        try {
            ...
            if ( $chunk->isValid() === false ) {
                throw new \Exception(trans('upload::messages.http_post_only'));
            }
