...
class Util
{
    ...
    {
        return new \Illuminate\Support\HtmlString('<input type="hidden" id="upload-storage-host" value="' . (self::isDistributedWebHost() ? ConfigMapper::get('distributed_deployment_storage_host') : '') . '" />');
    }
