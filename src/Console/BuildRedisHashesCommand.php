...
use Upload\ConfigMapper;
use Upload\SavedPathResolver;
use Upload\Util;
use Illuminate\Console\Command;
use Upload\RedisSavedPath;
...
class BuildRedisHashesCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'upload:build';
    ...
    public function handle()
    {
        ...
        try {
            ...
            foreach ( Config::get('upload.groups') as $groupName => $group ) {
